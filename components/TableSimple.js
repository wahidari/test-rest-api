export default function TableSimple({ className, head, bordered, children }) {
  return (
    ...
    `}>
      <div className="scrollbar-thin overflow-x-auto scrollbar-thumb-rounded scrollbar-thumb-gray-300 dark:scrollbar-thumb-neutral-700">
        <table className="w-full  text-neutral-800 dark:text-neutral-300">
          <thead>
